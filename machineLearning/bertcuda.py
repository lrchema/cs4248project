    ...
    def __init__(self, df):
        ...
        self.texts = [tokenizer(text, 
                               padding='max_length', max_length = 512, truncation=True,
                                return_tensors="pt") for text in df['clean']]
...
df['clean'] = df['clean'].apply(selectMiddle)
...
df_test = pd.read_csv("../dataset/testprep.csv")
df_test['clean'] = df_test['clean'].apply(selectMiddle)
